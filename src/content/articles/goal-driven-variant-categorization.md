...
dek: "arXiv:2609.22475v1 Announce Type: new Abstract: Process discovery rarely yields a single coherent process structure. For analysis, a common step is to cluster process variants based on structural similarity and then..."
domain: research
relevance: 4
author: "arXiv"
readTime: 1
...
*Source: [arXiv](https://arxiv.org/abs/2609.22475)*
