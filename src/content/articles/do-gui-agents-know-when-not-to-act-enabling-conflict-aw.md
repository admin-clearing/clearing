...
dek: "arXiv:2609.03438v1 Announce Type: new Abstract: Graphical user interface (GUI) agents are increasingly used to execute natural-language instructions on user interfaces, yet real users may issue infeasible instructions..."
domain: research
relevance: 5
author: "arXiv"
readTime: 1
...
*Source: [arXiv](https://arxiv.org/abs/2609.03438)*
