...
dek: "arXiv:2609.03236v1 Announce Type: new Abstract: Tool-using LLM agents spend wall-clock time not only on model inference but also in serial action--observation turns, where each tool call, environment transition, and..."
domain: research
relevance: 5
author: "arXiv"
readTime: 2
...
*Source: [arXiv](https://arxiv.org/abs/2609.03236)*
