...
dek: "arXiv:2609.17652v1 Announce Type: new Abstract: When agentic sessions run to a million tokens with many sessions resident at once, the KV cache and the index that ranks it live in host memory, and the scan that ranks..."
domain: research
relevance: 5
author: "arXiv"
readTime: 2
...
*Source: [arXiv](https://arxiv.org/abs/2609.17652)*
